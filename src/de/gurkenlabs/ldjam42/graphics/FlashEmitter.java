...
public class FlashEmitter extends EntityEmitter {

  public FlashEmitter(final IEntity entity) {
    super(entity);
    this.setOriginAlign(Align.CENTER);
    this.setOriginValign(Valign.MIDDLE);
    this.addParticleColor(new Color(200, 100, 200, 100), new Color(240, 140, 250, 100));
  }
